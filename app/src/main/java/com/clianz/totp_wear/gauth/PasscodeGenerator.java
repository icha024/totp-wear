...
package com.clianz.totp_wear.gauth;
...
public class PasscodeGenerator {
  ...
  public static Signer getSigningOracle(String secret) {
    try {
      ...
      Log.e("PasscodeGenerator", "NoSuchAlgorithmException: ", error);
    } catch (InvalidKeyException error) {
      Log.e("PasscodeGenerator", "InvalidKeyException: ", error);
    } catch (Base32String.DecodingException error) {
      Log.e("PasscodeGenerator", "DecodingException: ", error);
    }
